      ...
      <section className="max-w-4xl px-6 py-10 sm:mx-auto text-left">
        ...
        <section className="mx-auto max-w-4xl px-0 py-0 text-left">
          ...
          <article className="prose prose-neutral max-w-none text-left space-y-10 prose-headings:scroll-mt-24 prose-p:text-left prose-li:text-left prose-h2:text-left prose-h3:text-left">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p>
                    ...
                    requested via support, subject to the limitations in Section 12.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    support/billing issues, and meet accounting/audit needs.
                  </p>
                </div>
            ...
            <section id="choices-rights">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p>
                    Account deletion: There is currently no in‑app account deletion feature. If a deletion request is
                    received and verified, we will delete favorites keyed to the Google UID from our Firestore database
                    within a reasonable time, unless retention is required by law or to protect our Service.
                  </p>
                  <p>
                    Purchase records: Purchase and subscription records (including Google UID as App User ID and receipt
                    email where applicable) are retained indefinitely for entitlement restoration, fraud prevention, and
                    accounting/audit purposes. These records cannot be fully deleted while such obligations persist.
                    Where permissible, we may remove the email field from the purchase profile upon verified request
                    while retaining necessary purchase logs and identifiers.
                  </p>
                </div>
            ...
            <section id="contact">
              ...
              <p>
                For privacy inquiries, data access/deletion requests (favorites), or questions about this policy,
                contact:{" "}
                <a
                  className="font-medium text-[#333334] underline decoration-[#FCDA93] underline-offset-4"
                  href="mailto:beewalls.contact@beehomi.com"
        ...
        {/* <div className="mt-12 rounded-xl border border-[#F3E8C8] bg-[#FCDA93]/30 p-6">
          <p className="text-sm text-[#333334]">
            Tip: Link this page in‑app (Settings → Privacy) and on your Google Play listing. Ensure Play’s Data Safety
            form matches this policy.
          </p>
        </div> */}
      </section>
    </main>
