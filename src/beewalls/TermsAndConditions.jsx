            ...
            <article className="prose prose-neutral max-w-none text-left space-y-10 prose-headings:scroll-mt-24 prose-p:text-left prose-li:text-left prose-h2:text-left prose-h3:text-left">
              ...
              <section id="subscriptions">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold">9.4 Deletion and retention</h3>
                    <p>
                      In‑app deletion path: Settings → Delete Account → Confirm. This action permanently deletes synced
                      BeeWalls data tied to the signed‑in Google account (for example: cloud favorites) and cannot be
                      recovered. It does not cancel subscriptions or remove purchase/subscription records.
                    </p>
                    <p>
                      Retained records: Purchase and subscription records are retained indefinitely for entitlement
                      integrity, fraud prevention, and accounting/audit purposes. To stop future billing, manage or cancel
                      subscriptions in Google Play (Profile → Payments & subscriptions).
                    </p>
                  </div>
                </div>
              </section>
